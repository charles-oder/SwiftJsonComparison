...
public final class SJLSAVolume: NSCoding {
  ...
  public required init(json: JSON) {
    number = json[SerializationKeys.number].double
  ...
  required public init(coder aDecoder: NSCoder) {
    self.number = aDecoder.decodeObject(forKey: SerializationKeys.number) as? Double
