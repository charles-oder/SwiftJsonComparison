...
//import ObjectMapper
//
//class ObjectMapperTests: TestCase {
//        
//    func deserializeLargeComplexObject(jsonString: String) -> OMLargeComplexFile? {
//        return Mapper<OMLargeComplexFile>().map(JSONString: jsonString)
//    }
//    
//    func serializeLargeComplexObject(_ object: OMLargeComplexFile) -> String? {
//        return object.toJSONString()
//    }
//    
//    func deserializeLargeSimpleArray(jsonString: String) -> OMLargeSimpleArray? {
//        return Mapper<OMLargeSimpleArray>().map(JSONString: jsonString)
//    }
//    
//    func serializeLargeSimpleArray(_ object: OMLargeSimpleArray) -> String? {
//        return object.toJSONString()
//    }
//    
//    func deserializeMediumFile(jsonString: String) -> OMMediumFile? {
//        return Mapper<OMMediumFile>().map(JSONString: jsonString)
//    }
//    
//    func serializeMediumFile(_ object: OMMediumFile) -> String? {
//        return object.toJSONString()
//    }
//    
